...
class Shape {
    ...
    void set(Point upLeft, double w, double h) {
        // DIY here
        this.p = upLeft; this.w = w ; this.h = h ;
    }
...
class Ellipse extends Shape { // 橢圓形
    ...
    Ellipse(Point p,int a, int b){
        this.p = p ; this.w = a ; this.h = b ;
    }
    public String toString(){
        return String.format("center:(%d,%d), r1=%.1f, r2=%.1f" , this.p.x,this.p.y,this.w/2,this.h/2);
    }
    double calArea(){        
        return (this.h/2)*(this.w/2)*Math.PI;
    }
}

public class MI3C_HWK4_412631532_01 {
